...
namespace FoodOrderView
{
    public partial class FormMain : Form
    {
        ...
        private void блюдаСоСкладовToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var form = Container.Resolve<FormReportDishes>();
            form.ShowDialog();
        }
        ...
        {
            var form = Container.Resolve<FormReportStorageDishes>();
            form.ShowDialog();
        }
